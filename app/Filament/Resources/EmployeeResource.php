...
class EmployeeResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            FileUpload::make('civil_id_front')->label('صورة البطاقة - الأمام')->image()->directory('employees/civil_id_front'),
            FileUpload::make('civil_id_back')->label('صورة البطاقة - الخلف')->image()->directory('employees/civil_id_back'),
